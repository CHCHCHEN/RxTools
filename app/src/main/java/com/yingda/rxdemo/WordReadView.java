...
public class WordReadView extends FrameLayout implements TbsReaderView.ReaderCallback {
    ...
    public void loadFile(String filePath) {
        ...
        mTbsView = new TbsReaderView(getContext(), this);
        //去除最近文件按钮以及设置背景色为浅灰色
        mTbsView.setOnHierarchyChangeListener(new OnHierarchyChangeListener() {
            @Override
            public void onChildViewAdded(View parent, View childView) {
                if (childView instanceof FrameLayout) {
                    ...
                    frameLayout.setOnHierarchyChangeListener(new OnHierarchyChangeListener() {
                        @Override
                        public void onChildViewAdded(View parent, View childView) {
        ...
        bundle.putString("tempPath", "/storage/emulated/0/Android/data/com.yingda.rxdemo/files");
