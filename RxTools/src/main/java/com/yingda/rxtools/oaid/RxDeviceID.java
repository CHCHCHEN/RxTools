...
import com.yingda.rxtools.oaid.impl.OAIDFactory;
 ...
 * author: chen
 * data: 2024/8/18
 * des: 设备标识符工具类，建议使用{@link RxDeviceIdentifier}代替
*/
@SuppressWarnings("ALL")
public final class RxDeviceID {
    ...
    private static class Holder {
        static final RxDeviceID INSTANCE = new RxDeviceID();
    }
