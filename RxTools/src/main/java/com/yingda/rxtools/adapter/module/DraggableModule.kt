...
import com.yingda.rxtools.adapter.dragswipe.DragAndSwipeCallback
import com.yingda.rxtools.adapter.listener.DraggableListenerImp
import com.yingda.rxtools.adapter.listener.OnItemDragListener
import com.yingda.rxtools.adapter.listener.OnItemSwipeListener
 ...
 * author: chen
 * data: 2022/8/24
 * des: 需要【拖拽】功能的，[BaseQuickAdapter]继承此接口
 */
...
open class BaseDraggableModule(private val baseQuickAdapter: BaseQuickAdapter<*, *>) :
    ...
    open fun onItemSwiping(canvas: Canvas?,
