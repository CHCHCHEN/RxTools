...
import com.yingda.rxtools.adapter.animation.*
import com.yingda.rxtools.adapter.diff.BrvahAsyncDiffer
import com.yingda.rxtools.adapter.diff.BrvahAsyncDifferConfig
import com.yingda.rxtools.adapter.diff.BrvahListUpdateCallback
import com.yingda.rxtools.adapter.listener.*
import com.yingda.rxtools.adapter.module.*
...
@JvmOverloads constructor(@LayoutRes private val layoutResId: Int,
     ...
     * 当显示空布局时，是否显示 Header
     */
    private var headerWithEmptyEnable = false

    /** 当显示空布局时，是否显示 Foot */
    private var footerWithEmptyEnable = false
     ...
     * 动画是否仅第一次执行
     */
    private var isAnimationFirstOnly = true
    ...
    private fun hasFooterLayout(): Boolean {
     ...
     */
    private fun setEmptyView(emptyView: View) {
     ...
     */
    private fun setDiffConfig(config: BrvahAsyncDifferConfig<T>) {
    ...
    private fun getDiffer(): BrvahAsyncDiffer<T> {
